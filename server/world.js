export const LOCATIONS = [
  { id: 'the_glasshouse',      name: 'The Glasshouse',      x: 150, y: 300 },
  { id: 'the_fernery',         name: 'The Fernery',         x: 280, y: 180 },
  { id: 'the_bogwood',         name: 'The Bogwood',         x: 400, y: 260 },
  { id: 'the_canopy',          name: 'The Canopy',          x: 500, y: 150 },
  { id: 'the_thicket',         name: 'The Thicket',         x: 560, y: 300 },
  { id: 'the_walled_garden',   name: 'The Walled Garden',   x: 620, y: 420 },
  { id: 'the_cutting_garden',  name: 'The Cutting Garden',  x: 680, y: 550 },
  { id: 'the_salt_flats',      name: 'The Salt Flats',      x: 600, y: 680 },
  { id: 'the_terrace',         name: 'The Terrace',         x: 480, y: 760 },
  { id: 'the_coldhouse',       name: 'The Coldhouse',       x: 320, y: 780 },
  { id: 'the_undercroft',      name: 'The Undercroft',      x: 180, y: 680 },
  { id: 'the_seedbank',        name: 'The Seedbank',        x: 360, y: 660 },
  { id: 'the_nursery',         name: 'The Nursery',         x: 200, y: 500 },
  { id: 'the_still_pool',      name: 'The Still Pool',      x: 380, y: 430 },
  { id: 'the_orchard',         name: 'The Orchard',         x: 540, y: 530 },
];
